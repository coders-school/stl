...
TEST(advancedCalculatorTest, ShouldAdd) {
    ...
    EXPECT_EQ(process("5+ 11", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 16));
    EXPECT_EQ(process("43.21+11.54", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 54.75));
    EXPECT_EQ(process("-54.31 + 11", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, -43.31));
    EXPECT_EQ(process("28.43 +-810.43", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, -782));
    EXPECT_EQ(process("-11.230 + -77.321", &result), ErrorCode::OK);
...
TEST(advancedCalculatorTest, ShouldPower) {
    ...
    EXPECT_EQ(process("5 ^2", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 25));
    EXPECT_EQ(process("4.5^ 3", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 91.125));
    EXPECT_EQ(process("-5 ^3", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, -125));
    EXPECT_EQ(process("24.5^-2", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 0.00166597));
    EXPECT_EQ(process("-2 ^ -10", &result), ErrorCode::OK);
...
TEST(advancedCalculatorTest, ShouldCalculateRoot) {
    ...
    EXPECT_EQ(process("225 $3", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 6.0822));
    EXPECT_EQ(process("1024$ 2", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 32.));
    EXPECT_EQ(process("1024$4", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 5.65685));
    EXPECT_EQ(process("13.71 $-4", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 5.19686e-1));
    EXPECT_EQ(process("2.5 $ 2.5", &result), ErrorCode::OK);
...
TEST(advancedCalculatorTest, ShouldModulo) {
    ...
    EXPECT_EQ(process("225 %1000", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 225.0));
    EXPECT_EQ(process("7% 3", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 1.0));
    EXPECT_EQ(process("1024%7", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 2.0));
    EXPECT_EQ(process("1378 % 91", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 13.0));
    EXPECT_EQ(process("-2091% 67", &result), ErrorCode::OK);
...
TEST(advancedCalculatorTest, ShouldFactorial) {
    ...
    EXPECT_EQ(process("3.435!", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, 10.63327));
    EXPECT_EQ(process("-13!", &result), ErrorCode::OK);
    EXPECT_TRUE(cmp(result, -6227020800));
    EXPECT_EQ(process("-12.4!", &result), ErrorCode::OK);
...
TEST(advancedCalculatorTest, ShouldReturnBadFormat) {
    ...
    EXPECT_EQ(process("13.2 + 12.3 + 13.0", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("-12.4! + 2", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("11 / 13.4+", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("+8 - 32.1", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("12 ^% 3", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("+ 3 4", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("12.4.3 + 12.3", &result), ErrorCode::BadFormat);
    EXPECT_EQ(process("123.4 ! 345", &result), ErrorCode::BadFormat);
}

TEST(advancedCalculatorTest, ShouldReturnBadCharacter) {
    double result = 0;

    EXPECT_EQ(process("123 #- 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("123 @- 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("123 &- 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("123 ? 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("123 \\ 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("-123 [ -123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("-123 ] 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("-98 + 12.3 =", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("123 -#- 4", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("qwert + 123", &result), ErrorCode::BadCharacter);
    EXPECT_EQ(process("123,4 ; 345", &result), ErrorCode::BadCharacter);
}
...
TEST(advancedCalculatorTest, ShouldReturnModuleOfNonIntegerValue) {
    ...
    EXPECT_EQ(process("123 % 0.1", &result), ErrorCode::ModuleOfNonIntegerValue);
    EXPECT_EQ(process("123 % 0.0005", &result), ErrorCode::ModuleOfNonIntegerValue);
    EXPECT_EQ(process("123.1 % 0", &result), ErrorCode::ModuleOfNonIntegerValue);
    EXPECT_EQ(process("123.1 % 0.1", &result), ErrorCode::ModuleOfNonIntegerValue);
}

TEST(advancedCalculatorTest, ShouldReturnRootOfNegativeNumber) {
    double result = 0;

    EXPECT_EQ(process("-123 $ -1", &result), ErrorCode::SqrtOfNegativeNumber);
    EXPECT_EQ(process("-123.4 $ -1", &result), ErrorCode::SqrtOfNegativeNumber);
    EXPECT_EQ(process("-123.2 $ 1", &result), ErrorCode::SqrtOfNegativeNumber);
    EXPECT_EQ(process("-123 $ 1", &result), ErrorCode::SqrtOfNegativeNumber);
}
