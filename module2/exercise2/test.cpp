...
class Exercise2 :public ::testing::TestWithParam<std::pair<std::string, bool>> {
};

TEST_P(Exercise2, CheckPalindrome) {
...
INSTANTIATE_TEST_CASE_P(
  ...
  ::testing::Values(
    ...
    std::make_pair("Are we not pure? “No, sir!” Panama’s moody Noriega brags." 
                  "It is garbage!” Irony dooms a man—a prisoner up to new era.", true),
    std::make_pair("Dennis, Nell, Edna, Leon, Nedra, Anita, Rolf, Nora, Alice, Carol,"
                   ...
                   "Aaron, Flora, Tina, Arden, Noel, and Ellen sinned.", true),
