...
RecipitList FormatIngredients(const IngredientsList &ingredients, const UnitsDeque &units){
...
std::stringstream FormatRecipit(const StepList &steps, const IngredientsList &ingredients, const UnitsDeque &units){
...
void AppendNewRecipe(const StepList &steps, const IngredientsList &ingredients, const UnitsDeque &units){
